...
from src.entity.artifact_entity import (DataValidationArtifact,DataTransforamtionArtifacts)
...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->DataTransforamtionArtifacts:
        ...
        try:
            ...
            #preparing artifacts
            data_transformation_artifact = DataTransforamtionArtifacts(
